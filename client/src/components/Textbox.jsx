        ...
        <div className="w-full flex flex-col gap-1">
            ...
            <div>
                <input
                    ...
                    className={clsx(
                        `bg-transparent px-3 py-2.5 2xl:py-3 border border-gray-300 placeholder-gray-400 
                        text-gray-900 outline-none text-base focus:ring-2 ring-blue-300`, className)}
                />
            </div>
