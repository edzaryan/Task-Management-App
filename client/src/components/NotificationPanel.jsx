        ...
        <>
            <Popover className='relative'>
                <Popover.Button className='inline-flex items-center outline-none'>
                    <div className='w-8 h-8 flex items-center justify-center text-gray-700 relative'>
                        <IoIosNotificationsOutline className='text-[27px]' />
                        {data?.length > 0 && (
                            <span className='absolute grid justify-center items-center -top-1 -right-1 text-[13px] text-white font-semibold w-5 h-5 rounded-full bg-red-600'>
                                {data?.length}
                            </span>
                        )}
                    </div>
