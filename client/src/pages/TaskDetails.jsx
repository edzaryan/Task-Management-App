                                            ...
                                            <div key={index} className='flex gap-3'>
                                                ...
                                                <div className='space-y-1'>
                                                    <div className='flex gap-2 items-center'>
                                                        ...
                                                        <span
                                                            className='px-2 py-0.5 text-center text-sm rounded-full bg-violet-100 text-violet-700 font-semibold'>{el?.tag}</span>
                                                    </div>
...
const Activities = ({ activity, id, refetch }) => {
    ...
    return (
        <div
            className='w-full flex gap-10 2xl:gap-20 min-h-screen px-10 py-8 bg-white shadow rounded-md justify-between overflow-y-auto'>
